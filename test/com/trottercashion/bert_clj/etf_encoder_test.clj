...
(deftest should-encode-large-tuple
  (let [expected (concat (binary 131 105 0 0 1 0) (apply concat (take 256 (repeat '(110 1 0 2)))))]
...
(deftest should-encode-small-bignums
  (let [min-expected (binary 131 110 4 0 0 0 0 128)
        max-expected (concat (binary 131 110 255 1) (map unchecked-byte (take 255 (repeat 255))))
...
(deftest should-encode-large-bignums
  (let [expected (binary -125 110 8 0 0 0 0 0 0 0 0 1)
